...
@Component({
  selector: 'app-branded-food',
  templateUrl: './branded-food.component.html',
  styleUrls: ['./branded-food.component.css'],
   providers: [GroceryService]
})
export class BrandedFoodComponent implements OnInit {
@Input() grocerys: Grocery;
  constructor(private groceryService: GroceryService, private cartService: CartService, private _router: Router) {
    groceryService.brandedfood().subscribe(res => {
